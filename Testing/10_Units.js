// BigInt - 在以太坊中許多計算會超出 JavaScript 整數的安全值(9007199254740991)
import { ethers } from "ethers";
// 1. BigNumber
console.group('\n1. BigNumber类');

const oneGwei = ethers.getBigInt("1000000000"); // 從十進制字符串生成
console.log(oneGwei);
console.log(ethers.getBigInt("0x3b9aca00")); // 從hex字符串生成
console.log(ethers.getBigInt(1000000000)) // 從數字生成
